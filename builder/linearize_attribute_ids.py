...
def linearize_attributes(input_files, groups_file, output_file, organism_id,
    ...
    for input_file in input_files:
        ...
        attributes = pd.read_csv(input_file, sep='\t', header=0,
                            dtype='str', na_filter=False)
        
        attributes.rename(columns={attributes.columns[0]: "ID", attributes.columns[1]: "EXTERNAL_ID", attributes.columns[2]: "NAME", attributes.columns[3]: "DESCRIPTION"}, inplace = True)
